...
[T,Y] = ode45(@(t,y) Controller_with_paras_error(t,y,m1,m2,l1,l2,I1,I2,a,b,Kp,Kd),[0 time],ic,options); % Solve ODE with controller
...
% plot video
 plotTracking(l1,l2,y,time,t_int,a,b,'Control with parameters error'); 
...
figure;
%plot
suptitle('Simulation with paras error');
subplot(2,2,1);
